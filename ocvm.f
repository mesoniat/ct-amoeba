...
c
         write(iout,*) "My debug checks: "
         write(iout,*) grms, grdmin
         write(iout,*) f0, fctmin
         write(iout,*) niter, maxiter
         write(iout,*) f0prime, eps
...
c
         write(iout,*) "Small Move termination debug"
         write(iout,*) f0prime, -f0prime, "lt", eps
         write(iout,*) iprint, "gt", 0
         write(iout,*) niter, "ne", 0
         write(iout,*) f0, "lt", 1.0d8
         write(iout,*) f0, "gt", -1.0d7
         write(iout,*) grms, "lt", 1.0d6
