...
c
         ...
         do i = 1, npole
            ...
            f2 = 0.0d0
            f3 = 0.0d0
c           write(*,*) "i ",i," fuind x ",fuind(1,i)," y ",fuind(2,i),
c    &                     " z ",fuind(3,i)
c           write(*,*) "i ",i," fuinp x ",fuinp(1,i)," y ",fuinp(2,i),
c    &                     " z ",fuinp(3,i)
c           write(*,*) "i ",i," fphid x ",fphid(1,i)," y ",fphid(2,i),
c    &                     " z ",fphid(3,i)
c           write(*,*) "i ",i," fphip x ",fphip(1,i)," y ",fphip(2,i),
c    &                     " z ",fphip(3,i)
