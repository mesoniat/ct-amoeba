...
c MES : adding derivatives
      ...
      real*8, allocatable :: dfieldtdck(:,:)
      real*8, allocatable :: dfieldtpdci(:,:)
      real*8, allocatable :: dfieldtpdck(:,:)
...
c MES
      allocate (dfieldtdci(3,npole))
      allocate (dfieldtdck(3,npole))
      allocate (dfieldtpdci(3,npole))
      allocate (dfieldtpdck(3,npole))
      allocate (dfielddci(3,npole))
      allocate (dfieldpdci(3,npole))
c MES
      do j = 1,3
        do i = 1,npole
          dfieldtdci(j,i) = 0.0d0
          dfieldtdck(j,i) = 0.0d0
          dfieldtpdci(j,i) = 0.0d0
          dfieldtpdck(j,i) = 0.0d0
          dfielddci(j,i) = 0.0d0
          dfieldpdci(j,i) = 0.0d0
        end do
      end do
...
c MES
      ...
      deallocate (dfieldtdck)
      deallocate (dfieldtpdci)
      deallocate (dfieldtpdck)
